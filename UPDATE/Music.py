...
class playList: 
    ...
    def removeSong(self, song_id):
        ...
        # Kiểm tra nếu bài cần xóa đúng bằng bài đang phát
...
class MusicPlayer:
    def __init__(self, file_path="playlist.txt"):
        self.file_path = file_path          # Đã thêm file_path bị thiếu
    ...
    def load_data_from_file(self):
        ...
        for song_info in raw_data:
            ...
            self.song_hash_map[song_obj.song_id] = song_obj  # Đã đồng bộ thêm vào hash_map
    ...
    def add_new_song(self, song):
        ...
        self.song_hash_map[song.song_id] = song  # Cập nhật hash map
    ...
    def remove_song_by_id(self, song_id):
        ...
        if removed:
            if song_id in self.song_hash_map:
                del self.song_hash_map[song_id]  # Xóa khỏi hash map
            write_file(self.file_path, self.playlist)
